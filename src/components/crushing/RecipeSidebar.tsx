            ...
            return (
              ...
              >
                ...
                {ing.isByc && ing.bycAnalysis && (() => {
                  const activeMethod = ing.selectedBycMethod || ing.bycAnalysis.bestMethod || 'direct';
                  return (
                    <div className="pt-2 border-t border-slate-800/80 space-y-1.5">
                      <div className="flex items-center justify-between text-[11px]">
                        ...
                        {ing.bycAnalysis.savingsVsDirect > 0 && activeMethod !== 'direct' && (
                          <span className="text-emerald-400 font-bold font-mono text-[10px] bg-emerald-500/10 px-1.5 py-0.5 rounded border border-emerald-500/20">
                      ...
                      <div className="grid grid-cols-3 gap-1 text-[10px]">
                        ...
                        >
                          ...
                          {ing.bycAnalysis.bestMethod === 'direct' && (
                            <span className="text-[8px] text-amber-400 font-normal mt-0.5">Óptimo</span>
                          )}
                        </button>
                        ...
                        >
                          ...
                          {ing.bycAnalysis.bestMethod === 'fragments' && (
                            <span className="text-[8px] text-emerald-400 font-normal mt-0.5">Óptimo</span>
                          )}
                        </button>
                        ...
                        >
                          ...
                          {ing.bycAnalysis.bestMethod === 'map' && (
                            <span className="text-[8px] text-emerald-400 font-normal mt-0.5">Óptimo</span>
                          )}
                        </button>
                      </div>
