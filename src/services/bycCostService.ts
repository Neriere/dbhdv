...
/**
 * Obtiene los métodos de adquisición seleccionados por el usuario para recursos ByC
 */
...
/**
 * Guarda el método de obtención preferido para un recurso ByC y notifica el cambio
 */
export function saveStoredBycMethod(
  itemId: number,
  method: "direct" | "fragments" | "map",
  serverSlug?: string
